...
from .llama import complete_request
...
class ModelModule:
    ...
    def get_result(self, title: str, description: str, tags: list, link: str, category: str):
        ...
        views_count = self.prediction_pipeline(X_meta, X_emb)

        return {'views_prediction': views_count,
                'llama_response': complete_request(description, views_count, result['subscriber_count'], title)}
        

    def prediction_pipeline(self, X_meta, X_emb):
        ...
        return label_map[final_prediction[0]]
    ...
    def process_df(self, dataframe: pd.DataFrame, concat_embeddings=False):
       ...
       'view_count_7', 'view_count_8', 'view_count_9',
